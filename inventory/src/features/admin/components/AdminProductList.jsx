        ...
        <div className="bg-white">
          <div>
            ...
            <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                  ...
                  <div className="lg:col-span-3">
                    <div>
                      <Link to="/admin/productForm">
                        <button className="rounded-md mx-10 my-3 bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                          Add New Product
                        </button>
                      </Link>
                    </div>
              ...
              {/* sections of products and filters ends here */}
                ...
                <form className="mt-4 border-t border-gray-200 ">
                  ...
                  {filters.map((section) => (
                    <Disclosure
                      as="div"
                      key={section.id}
                      className="border-t border-gray-200 px-4 py-6 max-h-60 overflow-auto"
                    >
                      {({ open }) => (
                        <>
      ...
      <form className="hidden lg:block">
        ...
        {filters.map((section) => (
          <Disclosure
            as="div"
            key={section.id}
            className="border-b border-gray-200 py-6 max-h-64 overflow-auto"
          >
            {({ open }) => (
              <>
              ...
              <div key={product.id}>
                <Link to={`/productDetails/${product.id}`}>
                  <div className="group relative border-solid border-2 p-2 border-gray-200">
                    ...
                    <div className="mt-4 flex justify-between">
                      <div>
                        ...
                        <p className="mt-1 text-sm text-gray-500">
                          <StarIcon className=" w-7 h-7 inline"></StarIcon>
                    ...
                    <p className="text-sm text-gray-700">Qty:{product.stock}</p>
